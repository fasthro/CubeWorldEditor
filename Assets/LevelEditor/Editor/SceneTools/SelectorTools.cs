...
namespace LevelEditor
{
    ...
    public class SelectorTools : AbstractSceneTools, ISceneTools
    {
        ...
        public void OnSceneRender(SceneView sceneView, SceneRenderState state, Vector3 mousePosition)
        {
            ...
            {
                DrawGizmoCube(m_selectGrid.transform.position, Vector3.one, Color.yellow);
                ...
                DrawGizmoPosition(m_selectGrid.transform.position, m_selectGrid.transform.rotation, label);
            }
            else
            {
            ...
            {
                m_selectGrid = Environment.Inst.GetGrid(mousePosition, LevelEditorWindow.Inst.area);
